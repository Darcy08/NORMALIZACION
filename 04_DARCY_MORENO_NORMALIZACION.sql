...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2021 a las 17:44:23
...
(1, 'Alimentación', '2021-05-27', 2),
(2, 'Compra de cena', '2021-05-21', 2);
...
--
ALTER TABLE `tbl_inventario`
  ADD CONSTRAINT `FK_DIRECCIONES_INVENTARIO` FOREIGN KEY (`ID_DIRECCION`) REFERENCES `tbl_direcciones` (`ID_DIRECCION`);
